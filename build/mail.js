...
async function getEmailPrice({ users, years }) {
    const data = await makeRequest(`${WY_MAIL_API_BASE}/service/admin/price/?v=3&type=1g&num=${users}&year=${years}&t=1744551983336`, {
        method: 'GET',
    });
